...
- **Paused: D055 "squeeze the 47k"** (2026-09-08 →). Phase 0 done, Phase 1 (human
  ...
  batches through 2026-09-11. Phase 2's image slice still waits on image re-acquisition, which the
  acquisition loop's ingest provides. Narrative: `docs/decisions.md` D055.
