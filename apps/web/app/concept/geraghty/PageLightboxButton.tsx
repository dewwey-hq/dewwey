 ...
 * same component as Diamond Garden's, reused verbatim here for the same reason: thegeraghty.com
 * sends no X-Frame-Options/CSP header that would block framing (checked directly), so the
 * iframe genuinely renders their real virtual-tour page rather than a guessed embed.
 */
