...
/**
 * Same reasoning as Field Museum's AskAboutPricingButton (feedback 2026-08-15, reused here since
 * this venue has the identical shape: real pricing genuinely unpublished, "quoted upon request"):
 * keeps the user in-product instead of sending them to the venue's own contact page.
 */
...
/** Text-only trigger, matching every prior venue's pattern — no photo thumbnail. */
