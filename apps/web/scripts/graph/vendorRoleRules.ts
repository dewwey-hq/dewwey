...
const EXACT: Record<string, string[]> = {
  ...
  "bride's makeup": ["makeup"], "bride makeup": ["makeup"], "bridal party makeup": ["makeup"], mua: ["makeup"], "the makeup": ["makeup"], glam: ["makeup"],
  "glam for": ["makeup"], "glam on": ["makeup"], "glam squad": ["hair", "makeup"], "bridal party glam + hair": ["hair", "makeup"], lips: ["makeup"], lip: ["makeup"],
