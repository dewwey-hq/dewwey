...
export const VENDOR_ROLES: VendorRoleDef[] = [
  ...
  // attire (D0XX attire split, 2026-09-13): dress/suit/bridesmaid carved out of the old
  // generic `attire`; veil/shoes carved out of the old generic `accessories`. `attire`
  // itself is kept (last, below) as a legacy dead-letter — no longer a classifyLabel()
  // target, but still rendered sanely for any pre-migration row, same pattern as `hotel`.
  { slug: "wedding_dress", category: "attire", display: "Wedding Dress", isVendor: true },
  { slug: "menswear", category: "attire", display: "Menswear", isVendor: true },
  { slug: "bridesmaid_attire", category: "attire", display: "Bridesmaid Attire", isVendor: true },
  { slug: "veil_headpiece", category: "attire", display: "Veil & Headpiece", isVendor: true },
  { slug: "shoes", category: "attire", display: "Shoes", isVendor: true },
  { slug: "accessories", category: "attire", display: "Other Accessories", isVendor: true },
...
const EXACT: Record<string, string[]> = {
  ...
  "floral wholesaler": ["florist"], "floral purses": ["accessories"], "dress rentals": ["wedding_dress"], "veil by": ["veil_headpiece"], "bridal sari": ["wedding_dress"], "bridal assistant": ["staffing"],
  ...
  // attire — wedding dress / bridal wear (dress-shop, gown, and generic/ungendered bridal-attire
  // language — "outfit"/"fashion"/bare "attire" default here rather than a 9th generic bucket)
  dress: ["wedding_dress"], dresses: ["wedding_dress"], gown: ["wedding_dress"], gowns: ["wedding_dress"], "wedding dress": ["wedding_dress"], "wedding gown": ["wedding_dress"], "wedding gowns": ["wedding_dress"],
  "bridal gown": ["wedding_dress"], "bridal gowns": ["wedding_dress"], "bridal dress": ["wedding_dress"], "bridal attire": ["wedding_dress"], attire: ["wedding_dress"], "wedding attire": ["wedding_dress"],
  bridal: ["wedding_dress"], "bridal wear": ["wedding_dress"], "bridal apparel": ["wedding_dress"], "bridal outfit": ["wedding_dress"], "bridal wardrobe": ["wedding_dress"], "bridal boutique": ["wedding_dress"],
  "bridal shop": ["wedding_dress"], "bridal store": ["wedding_dress"], "bridal salon": ["wedding_dress"], "dress shop": ["wedding_dress"], "dress store": ["wedding_dress"], "dress boutique": ["wedding_dress"],
  "wedding dress shop": ["wedding_dress"], "gown salon": ["wedding_dress"], boutique: ["wedding_dress"], "dress designer": ["wedding_dress"], "dress designers": ["wedding_dress"], "gown designer": ["wedding_dress"],
  "wedding dress designer": ["wedding_dress"], "brides dress designer": ["wedding_dress"], "brides dress designer + shop": ["wedding_dress"],
  dresser: ["wedding_dress"], dressers: ["wedding_dress"], "wedding dresser": ["wedding_dress"], "dress by": ["wedding_dress"], "bride's dress": ["wedding_dress"],
  "brides dress": ["wedding_dress"], "bride dress": ["wedding_dress"], "bride's dresses": ["wedding_dress"], "bride's gown": ["wedding_dress"], "brides gown": ["wedding_dress"], "bride's attire": ["wedding_dress"],
  "bride attire": ["wedding_dress"], "brides attire": ["wedding_dress"], "brides wedding dress": ["wedding_dress"], "wedding dress attire": ["wedding_dress"], "second dress": ["wedding_dress"],
  "reception dress": ["wedding_dress"], "ceremony dress": ["wedding_dress"], "party dresses": ["wedding_dress"], "champagne dress": ["wedding_dress"], "morning dress": ["wedding_dress"],
  "private home dress": ["wedding_dress"], "saturday dress": ["wedding_dress"], "saturday second dress": ["wedding_dress"], "rehearsal dinner dress": ["wedding_dress"], "bride's ceremony gown": ["wedding_dress"],
  "brides ceremony dress": ["wedding_dress"], "second look": ["wedding_dress"], outfit: ["wedding_dress"], outfits: ["wedding_dress"], clothing: ["wedding_dress"], fashion: ["wedding_dress"],
  "fashion styling": ["wedding_dress"], "wardrobe styling": ["wedding_dress"], "wardrobe stylist": ["wedding_dress"], "bridal styling": ["wedding_dress"], "bridal stylist": ["wedding_dress"],
  "additional wardrobe": ["wedding_dress"], "bridal details": ["wedding_dress"],
  // attire — menswear (suit/tux, groom-specific attire language)
  suit: ["menswear"], suits: ["menswear"], suiting: ["menswear"], tux: ["menswear"], tuxes: ["menswear"], tuxedo: ["menswear"], tuxedos: ["menswear"], menswear: ["menswear"],
  mensware: ["menswear"], "men's attire": ["menswear"], "formal wear": ["menswear"], "groom attire": ["menswear"], "groom's attire": ["menswear"], "grooms attire": ["menswear"],
  "grooms' attire": ["menswear"], "groom's tux": ["menswear"], "grooms tux": ["menswear"], "groom tux": ["menswear"], "groom's suit": ["menswear"], "grooms suit": ["menswear"],
  "groom suit": ["menswear"], "groom's tuxedo": ["menswear"], "groom's outfit": ["menswear"], "grooms outfit": ["menswear"], "groom wedding day look": ["menswear"], "groom details": ["menswear"],
  "groom tux & accessories": ["menswear", "accessories"], "groom and groomsmen attire": ["menswear"], "groomsmen attire": ["menswear"], "groomsmen's tuxes": ["menswear"],
  groomsmen: ["menswear"], "guys attire": ["menswear"], "grooms people attire": ["menswear"], "wedding tux attire": ["menswear"], "second suit": ["menswear"], "custom coat": ["menswear"],
  gromswear: ["menswear"], "grooms suit designer + shop": ["menswear"],
  // attire — bridesmaid / bridal party attire
  bridesmaids: ["bridesmaid_attire"], "bridesmaids dresses": ["bridesmaid_attire"], "bridesmaid dresses": ["bridesmaid_attire"], "bridesmaids' dresses": ["bridesmaid_attire"], "bridesmaids dress": ["bridesmaid_attire"],
  "bridesmaid attire": ["bridesmaid_attire"], "bridsemaid attire": ["bridesmaid_attire"], "bm dresses": ["bridesmaid_attire"], "bridesmaids dress designer": ["bridesmaid_attire"],
  "wedding party attire": ["bridesmaid_attire", "menswear"], "brides people attire": ["bridesmaid_attire"],
  // attire — veil & headpiece (peeled from the old generic accessories)
  veil: ["veil_headpiece"], "custom veil": ["veil_headpiece"],
  // attire — shoes (peeled from the old generic accessories)
  shoes: ["shoes"], "bride's shoes": ["shoes"], "bridal shoes": ["shoes"], "wedding shoes": ["shoes"], "groom's shoes": ["shoes"], boots: ["shoes"],
  // attire — other accessories (narrowed catch-all: gloves, misc)
  accessories: ["accessories"], "bridal accessories": ["accessories"], "bride's accessories": ["accessories"], gloves: ["accessories"],
  // attire — compound dress+veil credits (dress half unambiguous; accessory half names the veil explicitly)
  "bridal gown & accessories": ["wedding_dress", "veil_headpiece"], "bride's dress & veil": ["wedding_dress", "veil_headpiece"],
  "dress and veil": ["wedding_dress", "veil_headpiece"], "gown & veil": ["wedding_dress", "veil_headpiece"],
...
const HEAD_RULES: HeadRule[] = [
  ...
  { id: "h.veil_headpiece", rx: /\b(veil|veils|headpiece|hairpiece)$/, roles: ["veil_headpiece"] },
  { id: "h.shoes", rx: /\b(shoes|boots|heels)$/, roles: ["shoes"] },
  { id: "h.accessories", rx: /\b(accessor(y|ies)|gloves)$/, roles: ["accessories"] },
  { id: "h.jewelry", rx: /\b(jewel(ry|lery|er|ers|s)|rings?|diamonds|earrings)$/, roles: ["jewelry"] },
  { id: "h.menswear", rx: /\b(suits?|suiting|tux|tuxes|tuxedos?|menswear|mensware)$/, roles: ["menswear"] },
  { id: "h.bridesmaid_attire", rx: /\bbridesmaids?$/, roles: ["bridesmaid_attire"] },
  { id: "h.wedding_dress", rx: /\b(dress|dresses|gowns?|attire|outfits?|wardrobe|apparel|clothing|fashion|bridal|boutique|salon|shop|store|designer)$/, roles: ["wedding_dress"] },
