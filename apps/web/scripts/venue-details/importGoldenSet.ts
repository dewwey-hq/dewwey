...
function buildMarchetti(): VenueDetailsV3 {
  ...
  doc.pricing = emptyPricing({
    ...
    add_ons: [
      ...
      rentalAddOn("bistro-lights-standard", "Bistro lights", "Standard", 1250, 1400, "Pavilion price shown is the 7-swag option; 13 swags is $2,200 (not modeled as a separate variant).", "lighting_av"),
      rentalAddOn("bistro-lights-greenery", "Bistro lights", "With faux greenery", 2250, 2500, "Pavilion price shown is the 7-swag option; 13 swags is $4,400 (not modeled as a separate variant).", "lighting_av"),
      {
        id: "chiavari-chairs",
