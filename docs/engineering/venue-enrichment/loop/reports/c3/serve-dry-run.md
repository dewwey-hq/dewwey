...
[serve-venue-details] batch_id: vd-serve-c3, prompt_version: venue-details-v3.2, reason: extract
[serve-venue-details] candidate accounts: 6
  account 31: run 25 (extract) -> version 1, changes: 1 (added 1, changed 0, removed 0), compare_ready=true, needs_review=false
      first paths: /
  ...
  account 477: run 24 (extract) -> version 1, changes: 1 (added 1, changed 0, removed 0), compare_ready=true, needs_review=false
      first paths: /
  ...
  account 27389: run 23 (extract) -> version 1, changes: 1 (added 1, changed 0, removed 0), compare_ready=false, needs_review=false
      first paths: /
  ...
  account 2785: run 28 (extract) -> version 1, changes: 1 (added 1, changed 0, removed 0), compare_ready=true, needs_review=false
      first paths: /
  ...
  account 1131: run 26 (extract) -> version 1, changes: 1 (added 1, changed 0, removed 0), compare_ready=false, needs_review=false
      first paths: /
  ...
  account 507: run 27 (extract) -> version 1, changes: 1 (added 1, changed 0, removed 0), compare_ready=false, needs_review=false
      first paths: /
