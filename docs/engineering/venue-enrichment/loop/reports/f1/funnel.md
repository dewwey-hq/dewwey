...
Generated 2026-09-20T21:25:59.648Z. prompt_version = venue-details-v3.5.
...
| crawled (>=5 usable pages) | 38 | 8.7% |
| extracted | 36 | 8.2% |
| validated ok | 34 | 7.8% |
| repaired | 11 | 2.5% |
| served | 33 | 7.6% |
| **compare_ready** | **24** | 5.5% |
| **excellent** | **12** | 2.7% |
...
- Websites checked: **306**
- Shells (zero usable pages, no text-layer PDF): **266** (86.9%)
